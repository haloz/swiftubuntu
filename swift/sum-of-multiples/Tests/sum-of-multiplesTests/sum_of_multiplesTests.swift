import XCTest
@testable import sum_of_multiples

class sum_of_multiplesTests: XCTestCase {
    func testSumTo1() {
    ...
    func testSumTo12() {
        XCTAssertEqual(33, SumOfMultiples.toLimit(12, inMultiples: [3, 5]))
    }   

    func testSumTo20() {
        XCTAssertEqual(78, SumOfMultiples.toLimit(20, inMultiples: [3, 5]))
    } 
    ...
    static var allTests : [(String, (sum_of_multiplesTests) -> () throws -> Void)] {
        return [
